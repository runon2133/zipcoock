...
<body>        	
	...
	<div class = "content_div">
       	<div class = "content_title">상품 Q</div>
       	<div class = "content_div_area">
       		<div class = "content_div_content">
				...
				<table class="table" style="margin-top:70px">
					...
					<th>제목</th>
					<td colspan="4">
						<input <c:if test="${not empty qna.aQnaWriter}">disabled="disabled"</c:if> type="text" maxlength="60" id="qnaTitle" class="form-control" value="${qna.qnaTitle }"> 
					</td>
					</tr>
					<tr>
					<th>이름</th>
					...
					<tr>
						<th>내용</th>
						<td colspan="4">
							<textarea <c:if test="${not empty qna.aQnaWriter}">disabled="disabled"</c:if> maxlength="650" id="qnaContent" class="form-control" style="height:300px">${qna.qnaContent }</textarea>
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="4">
							<div class="btn-area">
								<c:if test="${empty qna.aQnaWriter}">
        	...
        	<c:if test="${not empty qna.aQnaWriter}">
               	<div class = "content_title" id="a">A</div>
               	<div class = "content_div_area">
...
var memberNo = $("#memberNo").val()==""? 0:Number($("#memberNo").val());
	$("#updateQna").click(function() {
		...
		newForm.append($('<input/>', {type: 'hidden', name: 'q.qnaNo', value:$("#qnaNo").val() })); 
